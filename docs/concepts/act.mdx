...
job_title = result  # Result is returned as a dictionary or direct value
```
</Tab>
</Tabs>

Stagehand uses [Zod](https://zod.dev/) for TypeScript to help you define the schema of the data to be extracted. For Python, extraction returns structured data based on your instruction.
...
<Tab title="Python">
```python
# action is a dictionary version of a Playwright action:
# {
#	"description": "The jobs link",
#	"action": "click",
#	"selector": "/html/body/div[1]/div[1]/a",
