...
<Tip>For TypeScript: You can provide additional context at the field level within your schema using `.describe()`. For Python: Include specific formatting requirements in your instruction string.</Tip>
